...
class SgComputePrometheusCard extends SgComponent {
    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-prometheus-card' }
...
customElements.define('sg-compute-prometheus-card', SgComputePrometheusCard)
