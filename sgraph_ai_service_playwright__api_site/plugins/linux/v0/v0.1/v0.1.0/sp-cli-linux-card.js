...
const STATIC = { type_id: 'linux', display_name: 'Bare Linux', icon: '🐧', stability: 'stable', boot: '~60s', soon: false, create_endpoint_path: '/linux/stacks' }

class SpCliLinuxCard extends SgComponent {
    static jsUrl = import.meta.url
    get resourceName()   { return 'sp-cli-linux-card' }
    ...
    _launch() {
        document.dispatchEvent(new CustomEvent('sp-cli:plugin:linux.launch-requested', { detail: { entry: this._entry }, bubbles: true, composed: true }))
    }
}
customElements.define('sp-cli-linux-card', SpCliLinuxCard)
