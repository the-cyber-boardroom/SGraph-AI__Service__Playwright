...
class SgComputePodmanCard extends SgComponent {
    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-podman-card' }
...
customElements.define('sg-compute-podman-card', SgComputePodmanCard)
