...
class SgComputeSpecsView extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-specs-view' }
...
customElements.define('sg-compute-specs-view', SgComputeSpecsView)
