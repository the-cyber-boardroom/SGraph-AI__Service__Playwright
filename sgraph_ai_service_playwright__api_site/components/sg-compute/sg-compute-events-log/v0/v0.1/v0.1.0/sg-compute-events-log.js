/**
 * sg-compute-events-log — live DOM-event trace for the admin right column.
 *
 * Generalised version of sg-compute-vault-activity: listens for vault-bus
 * trace events, stack lifecycle, launch flow, nav, and plugin events.
 * Supports a filter dropdown (All / Vault / Stacks / Launch / Errors).
 *
 * @module sg-compute-events-log
 * @version 0.1.0
 */
...
class SgComputeEventsLog extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-events-log' }
...
customElements.define('sg-compute-events-log', SgComputeEventsLog)
