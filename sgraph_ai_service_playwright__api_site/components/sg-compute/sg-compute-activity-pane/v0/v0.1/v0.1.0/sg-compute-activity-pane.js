/**
 * sg-compute-activity-pane — Activity log for the admin dashboard.
 *
 * Listens for sp-cli:activity-entry events on document and appends them.
 *
 * @module sg-compute-activity-pane
 * @version 0.1.0
 */

import { SgComponent } from 'https://dev.tools.sgraph.ai/components/base/v1/v1.0/v1.0.0/sg-component.js'

class SgComputeActivityPane extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-activity-pane' }
...
customElements.define('sg-compute-activity-pane', SgComputeActivityPane)
