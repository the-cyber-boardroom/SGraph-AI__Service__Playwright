...
class SgComputeStorageViewer extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-storage-viewer' }
...
customElements.define('sg-compute-storage-viewer', SgComputeStorageViewer)
