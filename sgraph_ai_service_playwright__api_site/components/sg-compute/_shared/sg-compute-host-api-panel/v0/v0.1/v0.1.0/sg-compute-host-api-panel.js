...
class SgComputeHostApiPanel extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-host-api-panel' }
...
customElements.define('sg-compute-host-api-panel', SgComputeHostApiPanel)
