...
class SgComputeLauncherPane extends SgComponent {
    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-launcher-pane' }
    ...
    _renderCards() {
        ...
        for (const spec of enabled) {
            const card = document.createElement(`sg-compute-${spec.spec_id}-card`)
            this._grid.appendChild(card)
        }
    }
}

customElements.define('sg-compute-launcher-pane', SgComputeLauncherPane)
