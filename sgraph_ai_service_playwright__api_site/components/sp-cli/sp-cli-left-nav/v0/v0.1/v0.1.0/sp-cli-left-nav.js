/**
 * sp-cli-left-nav — vertical icon-rail navigation for the admin dashboard.
 *
 * Items: Compute / Storage / Settings / Diagnostics.
 * Click fires sp-cli:nav.selected { view } on document.
 *
 * @module sp-cli-left-nav
 * @version 0.1.0
 */

import { SgComponent } from 'https://dev.tools.sgraph.ai/components/base/v1/v1.0/v1.0.0/sg-component.js'

class SpCliLeftNav extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sp-cli-left-nav' }
...
customElements.define('sp-cli-left-nav', SpCliLeftNav)
