...
class SgComputeNodesView extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-nodes-view' }
...
customElements.define('sg-compute-nodes-view', SgComputeNodesView)
