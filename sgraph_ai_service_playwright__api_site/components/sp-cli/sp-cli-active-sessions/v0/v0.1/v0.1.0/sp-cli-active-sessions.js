/**
 * sp-cli-active-sessions — shows the current browser session.
 *
 * Multi-user tracking lands with the per-instance API brief.
 *
 * @module sp-cli-active-sessions
 * @version 0.1.0
 */

import { SgComponent } from 'https://dev.tools.sgraph.ai/components/base/v1/v1.0/v1.0.0/sg-component.js'

class SpCliActiveSessions extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sp-cli-active-sessions' }
...
customElements.define('sp-cli-active-sessions', SpCliActiveSessions)
