...
class SgComputeStopButton extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-stop-button' }
...
customElements.define('sg-compute-stop-button', SgComputeStopButton)
