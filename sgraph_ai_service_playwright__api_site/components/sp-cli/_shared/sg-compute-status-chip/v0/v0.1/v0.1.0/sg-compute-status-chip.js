...
class SgComputeStatusChip extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-status-chip' }
...
customElements.define('sg-compute-status-chip', SgComputeStatusChip)
