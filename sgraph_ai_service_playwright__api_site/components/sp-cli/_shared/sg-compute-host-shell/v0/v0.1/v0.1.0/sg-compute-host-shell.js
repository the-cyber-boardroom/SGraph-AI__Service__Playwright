...
class SgComputeHostShell extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-host-shell' }
...
customElements.define('sg-compute-host-shell', SgComputeHostShell)
