...
class SgComputeSsmCommand extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-ssm-command' }
...
customElements.define('sg-compute-ssm-command', SgComputeSsmCommand)
