/**
 * sp-cli-storage-view — Storage view placeholder.
 *
 * Full vault browser coming in a follow-up brief.
 *
 * @module sp-cli-storage-view
 * @version 0.1.0
 */
...
class SpCliStorageView extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sp-cli-storage-view' }
...
customElements.define('sp-cli-storage-view', SpCliStorageView)
