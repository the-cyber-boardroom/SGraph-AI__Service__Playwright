...
class SpCliLinuxDetail extends SgComponent {
    static jsUrl = import.meta.url
    get resourceName()   { return 'sp-cli-linux-detail' }
    ...
    async _fetchDetail(stack) {
        try {
            const info = await apiClient.get(`/linux/stack/${stack.stack_name}`)
...
customElements.define('sp-cli-linux-detail', SpCliLinuxDetail)
