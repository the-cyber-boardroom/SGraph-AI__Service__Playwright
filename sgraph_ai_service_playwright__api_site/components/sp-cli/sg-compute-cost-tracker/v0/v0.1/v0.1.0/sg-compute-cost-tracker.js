...
class SgComputeCostTracker extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-cost-tracker' }
...
customElements.define('sg-compute-cost-tracker', SgComputeCostTracker)
