/**
 * sg-compute-vault-status — shows the current vault connection in the right column.
 *
 * @module sg-compute-vault-status
 * @version 0.1.0
 */
...
class SgComputeVaultStatus extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()   { return 'sg-compute-vault-status' }
...
customElements.define('sg-compute-vault-status', SgComputeVaultStatus)
