/**
 * sg-compute-vault-picker — top-bar vault connection button + dropdown.
 *
 ...
 *
 * @module sg-compute-vault-picker
 * @version 0.1.0
 */
...
class SgComputeVaultPicker extends SgComponent {

    static jsUrl = import.meta.url
    get resourceName()  { return 'sg-compute-vault-picker' }
    get sharedCssPaths() {
...
customElements.define('sg-compute-vault-picker', SgComputeVaultPicker)
