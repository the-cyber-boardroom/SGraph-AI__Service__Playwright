...
|------------|----------------------------|-------------------------------------------------|------|
| 2026-04-17 | _pending_                  | Phase 2.6 — Browser__Launcher (real Chromium + env-var escape hatch; 5 integration tests live) | `2026-04-17__phase-2.6-browser-launcher.md` |
