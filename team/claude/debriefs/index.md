...
|------------|----------------------------|-------------------------------------------------|------|
| 2026-04-17 | `<backfill>`               | Phase 2.9 — Step__Executor (NAVIGATE / CLICK / FILL / SCREENSHOT / GET_CONTENT / GET_URL; 10 deferred stubs) + Artefact__Writer.capture_* + CI env-var hotfix for integration job | `2026-04-17__phase-2.9-step-executor.md` |
