...
| `M-014` | VERIFY markers in domain indexes — reconcile against post-BV2.11/BV2.12 deletions of `sgraph_ai_service_playwright/` and `agent_mitmproxy/` packages | 🟡 IN PROGRESS — agent dispatched | Librarian | this branch |
