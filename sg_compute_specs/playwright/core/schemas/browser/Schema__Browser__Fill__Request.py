# ═══════════════════════════════════════════════════════════════════════════════
# Playwright Service — Schema__Browser__Fill__Request (v0.1.24)
#
# Navigate + fill a single selector with a value. Returns final URL + timings.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Schema__Browser__Fill__Request(Type_Safe):
    url            : Safe_Str__Url
    selector       : Safe_Str__Selector
    value          : Safe_Str                                                       # Form-field value — arbitrary user input
