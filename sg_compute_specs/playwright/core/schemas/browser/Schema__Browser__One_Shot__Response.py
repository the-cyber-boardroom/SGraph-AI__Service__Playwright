...
class Schema__Browser__One_Shot__Response(Type_Safe):
    url         : Safe_Str__Url__Permissive                                         # RFC-compliant URL — BUG-1 (results may carry ':' in fragment)
    final_url   : Safe_Str__Url__Permissive = None                                  # Populated on navigate / click / get-url / get-content
