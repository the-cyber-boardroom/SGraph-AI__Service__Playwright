...
ACTION_HANDLERS = {
    ...
    Enum__Step__Action.GET_TEXT       : 'execute_get_text'       ,
    Enum__Step__Action.GET_HTML       : 'execute_get_html'       ,
    Enum__Step__Action.GET_DOM_TREE   : 'execute_get_dom_tree'   ,
    Enum__Step__Action.GET_A11Y_TREE        : 'execute_get_a11y_tree'        ,
    Enum__Step__Action.GET_PDF              : 'execute_get_pdf'              ,
    Enum__Step__Action.GET_CONSOLE_TAIL     : 'execute_get_console_tail'     ,
    Enum__Step__Action.GET_NETWORK_FAILURES : 'execute_get_network_failures' ,
