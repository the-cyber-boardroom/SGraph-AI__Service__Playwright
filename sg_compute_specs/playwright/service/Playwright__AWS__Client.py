# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — playwright: Playwright__AWS__Client
# Composition shell wiring the per-concern shared EC2 helpers for the
# playwright stack. Mirrors Vault_App__AWS__Client.
# ═══════════════════════════════════════════════════════════════════════════════
...
from sg_compute_specs.playwright.service.Playwright__Stack__Mapper import STACK_TYPE

PW_NAMING = Stack__Naming(section_prefix='pw')
...
class Playwright__AWS__Client(Type_Safe):
    ...
    def setup(self) -> 'Playwright__AWS__Client':
        self.sg       = EC2__SG__Helper      ().setup(PW_NAMING)
