# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — playwright: Playwright__AMI__Helper
# Resolves the base AMI for a playwright stack.
#
# Default: latest Amazon Linux 2023 (x86_64), from the SSM public parameter
# store. Fast-boot path: bake an AMI from a warm stack (`sg playwright ami
# bake`) with the container images already pulled, then launch with --ami <id>.
# `from_ami` overrides this helper.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Playwright__AMI__Helper(Type_Safe):
