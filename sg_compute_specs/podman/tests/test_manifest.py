...
class test_manifest(TestCase):
    ...
    def test_spec_id(self):
        assert MANIFEST.spec_id == 'podman'
    ...
    def test_boot_seconds_faster_than_docker(self):
        assert MANIFEST.boot_seconds_typical == 120                                 # Daemonless — boots faster than Docker
