# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — Prometheus: manifest contract test
# ═══════════════════════════════════════════════════════════════════════════════

from unittest                                                                       import TestCase

from sg_compute.core.spec.schemas.Schema__Spec__Manifest__Entry                     import Schema__Spec__Manifest__Entry
from sg_compute_specs.prometheus.manifest                                           import MANIFEST
...
class test_manifest(TestCase):
    ...
    def test_spec_id(self):
        assert MANIFEST.spec_id == 'prometheus'
    ...
    def test_nav_group_is_observability(self):
        from sg_compute.primitives.enums.Enum__Spec__Nav_Group import Enum__Spec__Nav_Group
        assert MANIFEST.nav_group == Enum__Spec__Nav_Group.OBSERVABILITY
