# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — edge: Schema__Edge__TXT__Record
...
class Schema__Edge__TXT__Record(Type_Safe):
    version  : Safe_Int__Edge__TXT_Version = Safe_Int__Edge__TXT_Version()      # the `v=` field; only 1 is valid today
    ip       : Safe_Str__IP__Address       = ''                                 # backend address
    port     : Safe_Int__Port              = Safe_Int__Port()                   # backend port (e.g. 8080)
    type     : Enum__Edge__Backend__Type   = Enum__Edge__Backend__Type.EC2      # ec2 / fargate
    launched : Safe_Int__Edge__Unix_Ts     = Safe_Int__Edge__Unix_Ts()          # unix ts for staleness detection
