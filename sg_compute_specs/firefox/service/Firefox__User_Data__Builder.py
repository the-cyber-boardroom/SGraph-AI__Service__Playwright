# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — Firefox: Firefox__User_Data__Builder
# Renders EC2 UserData for a jlesage/firefox + mitmproxy stack on AL2023.
# ═══════════════════════════════════════════════════════════════════════════════
...
for i in $(seq 1 30); do
    if [ -f {mitm_data_dir}/mitmproxy-ca-cert.pem ]; then
        echo "[sg-firefox] CA cert ready after ${{i}} x 2s"
        break
    fi
    sleep 2
done
