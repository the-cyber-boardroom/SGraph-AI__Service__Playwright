# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — vscode: Vscode__AWS__Client
# Composition shell wiring the per-concern AWS helpers for the vscode stack.
# ═══════════════════════════════════════════════════════════════════════════════
...
from sg_compute_specs.vscode.service.Vscode__Stack__Mapper import STACK_TYPE

VSCODE_NAMING = Stack__Naming(section_prefix='vscode')


class Vscode__AWS__Client(Type_Safe):
    ...
    def setup(self) -> 'Vscode__AWS__Client':
        self.sg       = EC2__SG__Helper      ().setup(VSCODE_NAMING)
