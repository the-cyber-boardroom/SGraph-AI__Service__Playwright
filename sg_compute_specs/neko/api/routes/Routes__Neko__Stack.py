# ═══════════════════════════════════════════════════════════════════════════════
# SG/Compute Specs — Neko: Routes__Neko__Stack
# ═══════════════════════════════════════════════════════════════════════════════
...
from sg_compute_specs.neko.service.Neko__Service                                    import DEFAULT_REGION, Neko__Service
...
class Routes__Neko__Stack(Fast_API__Routes):
    ...
    def list_stacks(self, region: str = '') -> dict:                                # GET /api/specs/neko/stacks
        return self.service.list_stacks(region or DEFAULT_REGION).json()
    list_stacks.__route_path__ = '/stacks'

    def info(self, name: str, region: str = '') -> dict:                            # GET /api/specs/neko/stack/{name}
    ...
    def create(self, body: dict) -> dict:                                           # POST /api/specs/neko/stack
    ...
    def delete(self, name: str, region: str = '') -> dict:                          # DELETE /api/specs/neko/stack/{name}
