...
HOST_PLANE_LOCAL_PORT    = 19009                  # 127.0.0.1:19009 → host-plane:8000 — SSM-port-forward target only
                                                  # (agent-mitmproxy runs mitmdump — no web UI / admin port to forward)
...
class Vault_App__Stack__Mapper(Type_Safe):
    ...
    def to_info(self, details: dict, region: str) -> Schema__Vault_App__Info:
        ...
        # agent-mitmproxy runs mitmdump (no web UI) — no mitmweb URL/forward to surface.
        mitmweb_url    = ''
        ...
        mitmweb_ssm_forward = ''                                                      # mitmdump has no web UI to forward to
