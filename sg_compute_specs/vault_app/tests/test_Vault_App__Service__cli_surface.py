...
class TestVaultAppServiceCliSurface:
    ...
    def test_user_data_timer_before_dnf(self):
        ...
        user_data = builder.render(stack_name='test-stack', access_token='tok', max_hours=1)
    ...
    def test_user_data_no_shutdown_when_max_hours_zero(self):
        builder   = Vault_App__User_Data__Builder()
        user_data = builder.render(stack_name='test-stack', access_token='tok', max_hours=0)
    ...
    def test_user_data_access_token_in_env(self):
        builder   = Vault_App__User_Data__Builder()
        user_data = builder.render(stack_name='test-stack', access_token='secret-tok-123')
