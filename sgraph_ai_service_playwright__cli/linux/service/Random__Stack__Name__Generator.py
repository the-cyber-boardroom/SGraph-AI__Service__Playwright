# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Random__Stack__Name__Generator (linux-local copy)
# Generates "{adjective}-{scientist}" identifiers for sp linux stacks. Mirrors
# the opensearch + elastic equivalents; each section is self-contained.
# Pure logic — no AWS calls.
# ═══════════════════════════════════════════════════════════════════════════════
