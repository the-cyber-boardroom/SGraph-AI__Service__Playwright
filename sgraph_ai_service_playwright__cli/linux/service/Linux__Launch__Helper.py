# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Linux__Launch__Helper
# Calls ec2.run_instances for a Linux stack. Mirrors OpenSearch__Launch__Helper.
# Single responsibility: launch only. Tag building + SG setup live in siblings.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Linux__Launch__Helper(Type_Safe):
