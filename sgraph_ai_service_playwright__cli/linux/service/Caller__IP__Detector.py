# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Caller__IP__Detector (linux-local copy)
# Returns the caller's public IPv4 for locking per-stack SG ingress to /32.
# Mirrors the opensearch + elastic helpers; each section is self-contained.
# ═══════════════════════════════════════════════════════════════════════════════
