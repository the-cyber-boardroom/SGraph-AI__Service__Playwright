# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Linux__Tags__Builder
# Builds the EC2 tag list for a Linux stack. Mirrors OpenSearch__Tags__Builder.
...
class Linux__Tags__Builder(Type_Safe):

    def build(self, stack_name: Safe_Str__Linux__Stack__Name, caller_ip: Safe_Str__IP__Address, creator: str = '') -> List[dict]:
        return [{'Key': 'Name'             , 'Value': LINUX_NAMING.aws_name_for_stack(stack_name)},
