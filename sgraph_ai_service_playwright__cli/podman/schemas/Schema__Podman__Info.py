# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Schema__Podman__Info
# Public view of one ephemeral Podman EC2 stack. Pure data.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Schema__Podman__Info(Type_Safe):
    ...
    podman_version    : Safe_Str__Text                                              # Populated by health check when instance is running
