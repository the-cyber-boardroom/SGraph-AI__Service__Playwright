...
# Sub-apps: dns, acm, billing, cf. Future siblings (lambda, ec2, iam, …) drop in next to them.
...
app = typer.Typer(name='aws', help='AWS resource management (DNS, ACM, billing, CloudFront, …).', no_args_is_help=True)
