...
# Sub-apps: dns, acm, billing. Future siblings (ec2, iam, …) drop in next to them.
...
app = typer.Typer(name='aws', help='AWS resource management (DNS, ACM, billing, …).', no_args_is_help=True)
