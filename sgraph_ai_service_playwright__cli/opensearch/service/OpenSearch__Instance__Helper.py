# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — OpenSearch__Instance__Helper
# Instance lookup + termination for sp os. Single responsibility: read-only
# discovery + terminate. Tag building lives in a sibling file.
#
# Filters all queries by sg:purpose=opensearch so multi-tenant accounts where
# many sp os stacks coexist still see only their own.
# ═══════════════════════════════════════════════════════════════════════════════
