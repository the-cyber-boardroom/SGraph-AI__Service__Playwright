# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Schema__OS__Stack__Delete__Response
# Returned by OpenSearch__Service.delete_stack. All fields empty when no stack
# matched the target — caller maps to HTTP 404. Mirrors
# Schema__Elastic__Delete__Response and Schema__Ec2__Delete__Response.
# Pure data.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Schema__OS__Stack__Delete__Response(Type_Safe):
    ...
    stack_name              : Safe_Str__OS__Stack__Name                             # Resolved logical name; empty on miss
