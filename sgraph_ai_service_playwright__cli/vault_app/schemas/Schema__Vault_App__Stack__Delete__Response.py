# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Schema__Vault_App__Stack__Delete__Response
# Returned by Vault_App__Service.delete_stack. All fields empty when no stack
# matched the target — caller maps to HTTP 404. Mirrors sister sections.
# Pure data.
# ═══════════════════════════════════════════════════════════════════════════════
...
class Schema__Vault_App__Stack__Delete__Response(Type_Safe):
    target                  : Safe_Str__Instance__Id                                # Resolved instance id; empty on miss
    stack_name              : Safe_Str__Vault_App__Stack__Name                      # Resolved logical name; empty on miss
