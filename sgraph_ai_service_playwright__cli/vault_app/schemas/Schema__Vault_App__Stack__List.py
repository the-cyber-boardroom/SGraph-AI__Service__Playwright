# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Schema__Vault_App__Stack__List
# Response wrapper for Vault_App__Service.list_stacks. Region on the envelope
...
class Schema__Vault_App__Stack__List(Type_Safe):
