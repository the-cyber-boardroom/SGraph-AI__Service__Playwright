# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Playwright__AMI__Helper
# AMI lookups for sp playwright. Single responsibility: read-only AMI queries.
# Mirrors Vnc__AMI__Helper — generic AL2023 lookup, no playwright-specific AMI.
# ═══════════════════════════════════════════════════════════════════════════════
