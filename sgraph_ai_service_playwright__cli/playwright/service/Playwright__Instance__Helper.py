# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Playwright__Instance__Helper
# Instance lookup + termination for sp playwright. Filters by
# sg:purpose=playwright. Mirrors Vnc__Instance__Helper.
# ═══════════════════════════════════════════════════════════════════════════════
...
from sgraph_ai_service_playwright__cli.playwright.service.Playwright__AWS__Client     import TAG_PURPOSE_KEY, TAG_PURPOSE_VALUE, TAG_STACK_NAME_KEY


INSTANCE_STATES_LIVE = ['pending', 'running', 'stopping', 'stopped']             # Excludes terminated/shutting-down


class Playwright__Instance__Helper(Type_Safe):
    ...
    def find_by_stack_name(self, region: str, stack_name: Safe_Str__Playwright__Stack__Name) -> Optional[dict]:
