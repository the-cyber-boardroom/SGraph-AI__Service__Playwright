# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Prometheus__Stack__Mapper
# Pure mapper from raw boto3 describe_instances detail dict → Type_Safe
# Schema__Prom__Stack__Info. Single responsibility: shape mapping. No AWS
...
def _tag(details: dict, key: str) -> str:                                           # boto3 describe_instances uses 'Tags' (capital T)
...
def _state_to_enum(state_str: str) -> Enum__Prom__Stack__State:                     # Map raw EC2 state to Prom lifecycle (READY is set by health probe)
