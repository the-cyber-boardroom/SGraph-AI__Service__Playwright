# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — Neko__Stack__Mapper
# Pure mapper: raw boto3 describe_instances dict → Schema__Neko__Stack__Info.
...
from sgraph_ai_service_playwright__cli.neko.service.Neko__AWS__Client               import TAG_ALLOWED_IP_KEY, TAG_STACK_NAME_KEY
