...
from sg_compute.host_plane.host.schemas.Schema__Host__Runtime                  import Schema__Host__Runtime
from sg_compute.host_plane.host.schemas.Schema__Host__Status                   import Schema__Host__Status
...
class Routes__Host__Status(Fast_API__Routes):
    ...
    def status(self) -> dict:                                               # GET /host/status
        ...
        try:
            count = get_pod_runtime().list().count
        except Exception:
            count = 0
