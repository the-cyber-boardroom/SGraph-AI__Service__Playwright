---
title: "Schema Catalogue (v2) — Part 2 — Core Schemas"
file: v0.20.55__schema-catalogue-v2__2__schemas.md
version: v0.20.55
date: 2026-04-16
parent: v0.20.55__schema-catalogue-v2.md
---

# Schema Catalogue (v2) — Part 2 — Core Schemas

Part 2 of 4. See the [cover sheet](v0.20.55__schema-catalogue-v2.md) for context and navigation.

This part covers Section 5 — all `Schema__*` Type_Safe data containers.
...
class Schema__Capture__Config(Type_Safe):                                           # What to capture + where to put it
    ...
    page_content        : Schema__Artefact__Sink_Config                             # HTML snapshot
