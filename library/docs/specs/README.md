...
| [`v0.2.6__spec-cli-contract.md`](v0.2.6__spec-cli-contract.md) | — | Canonical CLI contract every spec must satisfy — 8 standard verbs, name resolution rules, error handling, service interface, builder usage |
