# ═══════════════════════════════════════════════════════════════════════════════
# SP CLI — tests for Random__Stack__Name__Generator (opensearch-local)
# ═══════════════════════════════════════════════════════════════════════════════

from unittest                                                                       import TestCase

from sgraph_ai_service_playwright__cli.opensearch.service.Random__Stack__Name__Generator import (ADJECTIVES,
...
class test_Random__Stack__Name__Generator(TestCase):
    ...
    def test__shape_is_adjective_dash_scientist(self):                              # secrets.choice — sample to make sure both halves come from the right pool
    ...
    def test__pools_match_elastic(self):                                            # Sister sections share the vocabulary by design
